...
$t->write_file('index.html', 'hello, zionX!');

$t->run();

###############################################################################

like(http_get('/foo'), qr/hello, zionX!/, 'get index.html from foo servers');

like(http_get('/bar'), qr/hello, zionX!/, 'get index.html from bar servers');

like(http_get('/baz'), qr/hello, zionX!/, 'get index.html from baz servers');
